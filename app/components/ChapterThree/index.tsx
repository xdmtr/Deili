...
import { chapterThree } from "@/data/data";
...
const ChapterThree: React.FC = () => {
    return(
        <>
        <OnePage className="p-5 overflow-hidden gap-10" id="three">
        <div className="">
          <h1 className="font-zeyada text-3xl">Third Meet🤞🏻</h1>
