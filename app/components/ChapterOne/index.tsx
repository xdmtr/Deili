...
import { chapterOne } from "@/data/data";
...
const ChapterOne: React.FC = () => {
    return(
        <>
        <OnePage className="p-5 overflow-hidden gap-10" id="one">
        <div className="">
          <h1 className="font-zeyada text-3xl">Our first meet! Yeay 🎉✨</h1>
